...
def main():
    ...
    # Needs to loop over all combinations properly to find all overlaps, based on user code it only checks consecutive ones. Note that the events are sorted by start time. 
    # But I will provide the user's provided code verbatim first.
